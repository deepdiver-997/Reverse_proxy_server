...
```
src/
  main.cpp                      入口：N+1 线程布局 + work guard + 信号优雅退出
...
- [QUIC demux 设计蓝图](docs/design-quic-demux.md) — Model A：统一单入口 + co-located worker、CID 路由、发送契约
